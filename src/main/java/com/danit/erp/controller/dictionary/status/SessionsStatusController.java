...
public class SessionsStatusController {
  ...
  @GetMapping("/")
  public Page<SessionsStatus> getAll(@RequestParam int pageNumber, @RequestParam int pageSize) {
    return sessionsStatusService.getAllPageable(pageSize, pageNumber);
  }
